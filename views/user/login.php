...
<body>
<div class="image-container set-full-height" style="background-image: url('<?=$assets?>/views/assets/img/login/bg-login.jpg')">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="wizard-container">
                    <div class="card wizard-card" data-color="blue" id="wizardProfile">
                        <form action="<?=$assets?>/main/main" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-sm-offset-1">
                                            <div class="picture-container">
                                                <div class="picture">
                                                    <img src="<?=$assets?>/views/assets/img/default-avatar.png" class="picture-src" id="wizardPicturePreview" title=""/>
