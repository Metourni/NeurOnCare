            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                    <div class="card card-signup">
                        <form class="form" method="post" action="<?=$assets?>/admincmptministre/login">
                            ...
                            <div class="footer text-center">
                                <div class="errer" style="color: red">
                                    <?php
                                        if(isset($error))
                                            echo $error;
                                    ?>
                                </div>
                                <input type='submit' class='btn btn-previous btn-info btn-default btn-wd'
