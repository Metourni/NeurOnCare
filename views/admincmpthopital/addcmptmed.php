            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="wizard-container">
                    <div class="card wizard-card" data-color="blue" id="wizardProfile">
                        <form action="<?= $assets ?>/admincmpthopital/addcmptmed" method="post">
                            <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->

                            <div class="wizard-header">
                                <h3 class="wizard-title">
                                    Ajouter Compte Medcin
                                </h3>
                                <h5></h5>
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="about">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h4 class="info-text"> Plus de détail </h4>
                                        </div>
                            ...
                            <div class="wizard-footer">
                                ...
                                <a href="<?= $assets ?>/admincmpthopital/addcmptpat">
                                    <div class="pull-right">
                                        <input type='button' class='btn btn-fill btn-info btn-wd' name='add'
                                               value='Ajouter Patient'/>
                                    </div>
                                </a>
