                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <select name="location" type="text" class="form-control">
                                                            <option value="1">Établissement hospitalier Universitaire
                                                            </option>
                                                            <option value="2">Centre hospitalo-universitaire de
                                                                Beni-Messous
                                                            </option>
                                                            <option value="3">Centre hospitalo-universitaire de
                                                                Bab-El_Oued
                                                            </option>
                                                        </select>
                                                    </div>
...
<?php else: ?>
    <?php
    $url = '/projet1cs/admincmpthopital/index';
