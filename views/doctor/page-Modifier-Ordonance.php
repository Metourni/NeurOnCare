...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="page-title">
            <div>
                <h1><i class="fa fa-edit"></i> Dose</h1>
                <p>Modifier Dose </p>
            </div>
            <div>
                <ul class="breadcrumb">
                    <li><i class="fa fa-home fa-lg"></i></li>
                    <li><a href="#">Modifier Dose</a></li>
                </ul>
            </div>
        </div>
        <div class="row">
                            ...
                            <form method="post" action="">
                                <div class="ordon">
                                    <div class="row mb-20" id="1">
                                        ...
                                        <br>
                                        <div class="col-md-4">
                                            <button class="btn btn-danger del" type="button"><i
                                                    class="fa fa-fw fa-lg fa-close"></i>
                                            </button>
                                        </div>
